(() => {
const K='m2z_admin_key';const DEV_KEY_DEFAULT='';
...
window.AdminAuth.init({loginView:$('loginView'),panelView:$('panelView'),loginForm:$('loginForm'),emailInput:$('adminEmail'),passwordInput:$('adminPassword'),googleBtn:$('googleLoginBtn'),errorEl:$('loginError'),logoutBtn:$('logoutBtn'),userEl:$('adminUser'),onReady:updateAccess});
$('saveKeyBtn').onclick=()=>{const v=$('awApiKey').value.trim();if(v&&!v.includes('•'))localStorage.setItem(K,v);updateAccess();};
